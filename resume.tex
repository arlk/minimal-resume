...
\begin{lonelist}
\item[] $\mathcal{RL}_1-\mathcal{GP}$: Safe simulataneous learning and control. \\
A. Gahlawat$^\star$, \textbf{A. Lakshmanan$^\star$}, L. Song, A. Patterson, Z. Wu, N. Hovakimyan, and E. Theodorou. \textit{(submitted to the Conference on Robot Learning (CoRL) 2020)}. \url{https://arxiv.org/pdf/2009.03864.pdf} \bigskip

\item[]  Safe feedback motion planning: A contraction theory and $\mathcal{L}_1$-adaptive control based approach. \\
\textbf{A. Lakshmanan$^\star$}, A. Gahlawat$^\star$, and N. Hovakimyan. In \textit{IEEE Conference on Decision and Control (CDC) 2020}, Dec 2020.\astfootnote{$^\star$equal contribution} \url{https://arxiv.org/pdf/2004.01142.pdf} \smallskip

\item[] 
Intent-aware probabilistic trajectory estimation for collision prediction with uncertainty quantification. \\
A. Patterson, \textbf{A. Lakshmanan}, and N. Hovakimyan. In \textit{IEEE Conference on Decision and Control (CDC) 2019}, Dec 2019. \url{https://ieeexplore.ieee.org/document/9029215} \bigskip

\item[] Proximity queries for absolutely continuous curves. \\
\textbf{A. Lakshmanan}, A. Patterson, V. Cichella, and N. Hovakimyan. In \textit{Proceedings of Robotics: Science and Systems (RSS)}, June 2019. \url{http://www.roboticsproceedings.org/rss15/p42.pdf} \bigskip

\item[] Design and control of a small aerial manipulator for indoor environments. \\
R. M. Jones, D. Sun, G. B. Haberfeld, \textbf{A. Lakshmanan}, T. Marinho, and N. Hovakimyan. In \textit{AIAA Information Systems-AIAA Infotech@ Aerospace}, Jan 2017.  \url{https://arc.aiaa.org/doi/10.2514/6.2017-1374} \bigskip

\item[]  Piecewise Bézier curve trajectory generation and control for quadrotors. 
\textbf{A. Lakshmanan}. \textit{Master's Thesis, University of Illinois at Urbana-Champaign}, Dec 2016.  \url{https://www.ideals.illinois.edu/handle/2142/95352} \bigskip
