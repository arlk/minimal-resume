...
\newcommand{\github}{\href{http://github.com/arunlakshmanan}{github.com/arlk}}
\newcommand{\website}{\href{www.arunlakshmanan.com}{arunl.com}}
...
\section{Education}
\textbf{PhD Mechanical Science and Engineering}   \hfill \textbf{Jan 2017 - }\textbf{present}\\
...
\textit{Optimal Aerospace Systems, Machine Learning for Signal Processing, Advanced Robotics Planning, Robust Adaptive Control, Nonlinear Systems, Introduction to Robotics, and Digital Control Systems.}
...
\begin{outerlist}
\item Presently working towards designing motion planning methods which can compute optimal trajectories in cluttered spaces in a computationally efficient manner.
...
\href{https://paracosm.io/}{\textbf{Paracosm/Occipital}, Gainesville, FL.}
\hfill \textbf{May 2017 - Jul 2017} \\
\textit{Intern Engineer}%
\begin{outerlist}
\item Developed a motion planning library and associated unit tests for applications to request collision free paths when provided with a occupancy map.
\end{outerlist}
\blankline
...
I have extensive experience with robotics development on quadrotors and ground robots in the areas of controller architecture design, motion planning and trajectory optimization. I am very interested in computationally efficient solutions to trajectory generation for mobile robots in cluttered environments. \medskip

I am adept at writing \textbf{C}/\textbf{\CPP} software for embedded systems, \textbf{Python} for rapid prototyping and high-level decision making, \textbf{ROS} packages for communication services, and \textbf{Julia}, \textbf{MATLAB} and \textbf{Simulink} models for analysis and design. I have primarily developed software for ARM-based processors running Linux/FreeRTOS environments. \medskip

%Programming Languages \textit{(in order of comfort)}: Julia, Python, MATLAB, \CPP, C
\section{Programming Experience}
\begin{lonelist}
\item Languages: Julia (9/10), Python (9/10), C/\CPP (7-8/10), C\# (7/10)
\item OS/Middleware: Linux (9/10), ROS (8/10), FreeRTOS (7/10)
\item Software: MATLAB/Simulink (9/10), Unity3D (7/10)
\item Favorite Text Editor : Vim
\end{lonelist}
